...
var submitButtonPressed = function(e) {
    var successMessage = document.getElementById("successMessage"),
        category         = document.getElementById("categoryToRemove"),
        loadingImage   = document.getElementById("loadingImage");
    successMessage.hidden = true;
    nameValue = categoryToRemove.options[categoryToRemove.selectedIndex].value;
...
var submitData = function(nameValue) {
    ...
    var parameters = "category=" + nameValue;
    var client = new XMLHttpRequest();
    client.open("POST", "files/php/submit/removeCategory.php", true);
